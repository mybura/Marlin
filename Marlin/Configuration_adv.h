...
#define DEFAULT_STEPPER_DEACTIVE_TIME 240     // disable steppers after 3min to ensure bed does not drop before print
...
//#define SLOWDOWN // Does not work with kinematics
